...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.cliapplication.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".cliapplication" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".cliapplication")
	}
